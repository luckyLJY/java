 ...
 * @author LJY
 * @description
 * @createdate 2021/3/24:10:48
 */
public class HeaderRcvi1 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        headers_eamil.put("inform_email","email");
...
//            channel.queueDeclare(String queue, boolean durable, boolean exclusive, boolean autoDelete, Map<String, Object> arguments)
         ...
         * 3、路由key
         */
        channel.queueBind(QUEUE_INFORM_EMAIL,EXCHANGE_HEADERS_INFORM,"",headers_eamil);
