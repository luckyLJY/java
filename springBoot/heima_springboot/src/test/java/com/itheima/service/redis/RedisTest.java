...
public class RedisTest {
    ...
    public void test(){
        ...
        //sorted set 有序集合
        redisTemplate.boundZSetOps("z-key").add("a", 30);
        redisTemplate.boundZSetOps("z-key").add("b", 20);
        redisTemplate.boundZSetOps("z-key").add("c", 10);
        set = redisTemplate.boundZSetOps("z-key").range(0,-1);
        System.out.println("sorted set有序集合的元素 "+ set);
    }
}
