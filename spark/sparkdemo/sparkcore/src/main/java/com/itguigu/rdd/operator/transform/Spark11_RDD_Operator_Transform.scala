 ...
 * Package: com.itguigu.rdd.operator.transform
 * Version: 1.0
 * Created by ljy on 2022-1-5 10:32
 */

/**
 * @ClassName Spark11_RDD_Operator_Transform
 * @Author: ljy on 2022-1-5 10:32
 * @Version: 1.0
 * @Description:
 * repartition
...
object Spark11_RDD_Operator_Transform {
  def main(args: Array[String]): Unit = {
    val sparkConf: SparkConf = new SparkConf().setMaster("local[*]").setAppName("repartionRDD")
